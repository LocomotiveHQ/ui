...
declare const FormHelpText: (p: any) => react_jsx_runtime.JSX.Element;
declare const FormControlLabel: (p: JSX.IntrinsicElements['label']) => react_jsx_runtime.JSX.Element;
declare const FormControl: (p: JSX.IntrinsicElements['input']) => react_jsx_runtime.JSX.Element;
declare const Joined: (p: {
    className?: string;
    children?: ReactNode;
}) => react_jsx_runtime.JSX.Element;
declare const Addon: react.FunctionComponent<any>;
