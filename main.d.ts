...
declare class NumberVar<Name extends string = string> {
    name: Name;
    value_: number | (() => number);
    get value(): number;
    constructor(name: Name, value_: number | (() => number));
    toString(): string;
}
/**
 * extract value from a number of NumberVar
 */
declare function getNum(a: Maybe<number | NumberVar>, def?: undefined): number | undefined;
declare function getNum(a: Maybe<number | NumberVar>, def: number): number;
...
type WidgetLabelContainerProps = {
    justify: boolean;
    className?: string;
    children: React.ReactNode;
};
declare const WidgetLabelContainerUI: react.FunctionComponent<WidgetLabelContainerProps>;
...
declare abstract class BaseWidget {
    ...
    UIErrors: () => react_jsx_runtime.JSX.Element;
    UILabelCaret: () => react_jsx_runtime.JSX.Element;
    UILabelIcon: () => react_jsx_runtime.JSX.Element;
    UILabelContainer: (p: WidgetLabelContainerProps) => react_jsx_runtime.JSX.Element;
    UIHeaderContainer: (p: {
        children: ReactNode;
    }) => react_jsx_runtime.JSX.Element;
...
BUILDER extends IFormBuilder = IFormBuilder> {
    ...
    serialChanged: (_widget: BaseWidget) => void;
...
declare const clampOpt: (v?: number, min?: number, max?: number) => number;
...
declare function getLCHFromString(str: string): OKLCH;
...
type BoxNormalized = {
    ...
    text: Kolor | null;
    border: Kolor | null;
    textShadow: Kolor | null;
    shadow: Kolor | null;
};
declare function extractNormalizeBox(box: Box): BoxNormalized;
declare function normalizeBoxKolor(kolor: Kolor | string | number | boolean | undefined): Kolor | null;

declare const applyKolorToOKLCH: (a: OKLCH, b?: Maybe<Kolor>) => OKLCH;
 ...
 */
declare const overrideKolor: (a: Kolor | null, b: Kolor | null) => Kolor | null;
...
declare const CurrentStyleCtx: react.Context<CurrentStyle>;

declare const applyBoxToCtx: (ctx: CurrentStyle, box: BoxNormalized) => CurrentStyle;
declare const hashKolor: (k: Kolor) => string;

declare const usePressLogic: (p: {
    onMouseDown?: (ev: React.MouseEvent<HTMLDivElement>) => void;
    onMouseEnter?: (ev: React.MouseEvent<HTMLDivElement>) => void;
    onClick?: (ev: React.MouseEvent<HTMLDivElement>) => void;
}, value: boolean) => {
    onMouseDown: ((ev: React.MouseEvent<HTMLDivElement>) => void) | undefined;
    onMouseEnter: ((ev: React.MouseEvent<HTMLDivElement>) => void) | undefined;
};

declare const compileKolorToCSSExpression: (from: string, kolor: Kolor) => string;

declare function formatOKLCH(col: OKLCH): string;

/** quick alias */
type Selector = string;
/** return true when rule has already been defined for given selector */
declare const hasRule: (selector: Selector) => boolean;
declare function addRule(selector: string, block?: string): CSSStyleRule;

declare const exhaust: (x: never) => never;

type RSSize = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'input';

type FrameSize = {
    size?: Maybe<RSSize>;
    square?: boolean;
};
declare function getClassNameForSize(p: FrameSize): "h-input" | "w-6 h-6" | "w-8 h-8" | "w-10 h-10" | "w-12 h-12" | "w-14 h-14" | "w-input h-input" | "text-xs px-0.5 py-0.5 line-height-[1.1em]" | "text-sm px-1   py-1   line-height-[1.1em]" | "        px-2   py-1   line-height-[1.1em]" | "text-lg px-4   py-2   line-height-[1.1em]" | "text-xl px-8   py-8   line-height-[1.1em]" | "" | undefined;

declare const frames: {
    ghost: BoxNormalized;
    subtle: BoxNormalized;
    default: BoxNormalized;
    primary: BoxNormalized;
    secondary: BoxNormalized;
};
type FrameAppearance = keyof typeof frames;
...
FrameSize;
declare const Frame: react.MemoExoticComponent<react.ForwardRefExoticComponent<Omit<Omit<FrameProps, "ref"> & react.RefAttributes<unknown>, "ref"> & react.RefAttributes<unknown>>>;
...
declare const Button: react.FunctionComponent<{
    ...
    onClick?: ((ev: react.MouseEvent<HTMLDivElement, MouseEvent>) => void) | undefined;
    onMouseDown?: ((ev: react.MouseEvent<HTMLDivElement, MouseEvent>) => void) | undefined;
    onMouseEnter?: ((ev: react.MouseEvent<HTMLDivElement, MouseEvent>) => void) | undefined;
    onMouseLeave?: ((ev: react.MouseEvent<HTMLDivElement, MouseEvent>) => void) | undefined;
    onContextMenu?: ((ev: react.MouseEvent<HTMLDivElement, MouseEvent>) => void) | undefined;
    onAuxClick?: ((ev: react.MouseEvent<HTMLDivElement, MouseEvent>) => void) | undefined;
    onWheel?: ((ev: react.WheelEvent<HTMLDivElement>) => void) | undefined;
    onFocus?: ((ev: react.FocusEvent<HTMLDivElement, Element>) => void) | undefined;
    onBlur?: ((ev: react.FocusEvent<HTMLDivElement, Element>) => void) | undefined;
    onChange?: ((ev: react.ChangeEvent<HTMLDivElement>) => void) | undefined;
    onKeyUp?: ((ev: react.KeyboardEvent<HTMLDivElement>) => void) | undefined;
    onKeyDown?: ((ev: react.KeyboardEvent<HTMLDivElement>) => void) | undefined;
} & FrameSize & {
...
type RevealProps = {
     ...
     */
    enterable?: boolean;
    content: (p: RevealState) => react__default.ReactNode;
...
declare class Widget_bool extends BaseWidget implements IWidget<Widget_bool_types> {
    ...
    readonly DefaultHeaderUI: react.FunctionComponent<{
        widget: Widget_bool;
    }>;
    readonly DefaultBodyUI: undefined;
    readonly id: string;
...
declare class Widget_choices<T extends SchemaDict = SchemaDict> extends BaseWidget implements IWidget<Widget_choices_types<T>> {
    ...
    UITab: () => react_jsx_runtime.JSX.Element;
    UISelect: () => react_jsx_runtime.JSX.Element;
    UIChildren: () => react_jsx_runtime.JSX.Element;
    DefaultHeaderUI: react.FunctionComponent<{
...
declare const InputBoolUI: react.FunctionComponent<BoolButtonProps>;

declare const InputBoolCheckboxUI: react.FunctionComponent<BoolButtonProps>;

declare const InputBoolToggleButtonUI: react.FunctionComponent<BoolButtonProps>;
...
/** default error block */
declare const WidgetErrorsUI: react.FunctionComponent<{
    widget: BaseWidget;
}>;

declare const WidgetHeaderContainerUI: react.FunctionComponent<{
    widget: BaseWidget;
    children?: React.ReactNode;
}>;

declare const WidgetLabelCaretUI: react.FunctionComponent<{
    widget: BaseWidget;
}>;
declare const WidgetLabelCaretAlwaysUI: react.FunctionComponent<{
    isCollapsed: boolean;
}>;
...
declare const WidgetLabelIconUI: react.FunctionComponent<{
    widget: BaseWidget;
}>;
...
declare const ErrorBoundaryUI: react.FunctionComponent<{
    children: React.ReactNode;
}>;
...
declare const WidgetHeaderControlsContainerUI: react.FunctionComponent<{
    className?: string | undefined;
    children: React.ReactNode;
}>;
...
declare function MenuDividerUI_(): react_jsx_runtime.JSX.Element;

declare const WidgetMenuUI: react.FunctionComponent<{
    className?: string | undefined;
    widget: IWidget;
}>;
...
declare const WidgetUndoChangesButtonUI: react.FunctionComponent<{
    className?: string | undefined;
    widget: IWidget;
}>;
...
declare const WidgetFieldsContainerUI: react.FunctionComponent<{
    layout?: "H" | "V" | undefined;
    className?: string | undefined;
    children?: React.ReactNode;
}>;
...
declare const WidgetChoices_TabHeaderUI: (<T extends SchemaDict>(p: {
    widget: Widget_choices<T>;
}) => react_jsx_runtime.JSX.Element) & {
    displayName: string;
};
...
declare function getLCHFromStringAsString(str: string): string;
...
export { $WidgetSym, type $WidgetTypes, ASSERT_ARRAY, ASSERT_EQUAL, ASSERT_STRING, type Activity, AnimatedSizeUI, AspectLockButtonUI, AspectRatioSquareUI, AutoCompleteSelectState, type BaseSelectEntry, BaseWidget, BoolButtonProps, BoundCommand, type BoundCommandOpts, BoundCommandSym, BoundMenu, type BoundMenuOpts, BoundMenuSym, BoxBase, type BoxNormalized, BoxSubtle, BoxTitle, Button, ComboUI, Command, CommandContext, CommandManager, CommandSym, type CurrentStyle, CurrentStyleCtx, CushyKitCtx, type CushyShortcut, type DomId, ErrorBoundaryFallback, ErrorBoundaryUI, FAIL, Form, FormAsDropdownConfigUI, FormManager, type FormProperties, type FormSerial, FormUI, type FormUIProps, Frame, type FrameAppearance, type FrameProps, type FrameSize, type GetWidgetResult, type GetWidgetState, GlobalFormCtx, type IFormBuilder, type INodeStore, type ISpec, type IWidget, type IWidgetListLike, type IconName, Ikon, IkonOf, InputBoolCheckboxUI, InputBoolToggleButtonUI, InputBoolUI, InputNumberUI, type InstructType, JsonViewUI, KEYS, type KeyEv, type KeyName, ListControlsUI, META_NAME, MOD_KEY, ManualPromise, MarkdownUI, Menu, type MenuDef, MenuDividerUI_, type MenuEntry, type MenuEntryWithKey, type MenuID, MenuInstance, MenuItem, MenuRootUI, MenuUI, MenuWithoutProps, MessageErrorUI, ModalShellUI, type MoveConflictResolution, type NodeData, type NodeId, type NodeKey, type NodeKeyKind, NumberVar, type OopenRouter_ModelInfo, type OpenRouter_Models, type Problem, type Problem_Ext, RenderItemTitleUI, ResolutionState, RevealCtx, type RevealPlacement, type RevealStack, RevealState, RevealStateLazy, RevealUI, type SBool, type SButton, type SChoices, type SColor, type SGroup, type SList, type SMarkdown, type SMatrix, type SNumber, type SOptional, type SQLITE_boolean, type SQLITE_boolean_, SQLITE_false, SQLITE_true, type SSeed, type SSelectMany, type SSelectMany_, type SSelectOne, type SSelectOne_, type SSize, type SSpacer, type SString, type SchemaDict, SelectPopupUI, type SelectProps, SelectUI, Severity, type SharedWidgetConfig, type SharedWidgetSerial, SimpleFormBuilder, SimpleFormManager, SimpleMenuAction, SimpleMenuModal, SimpleSpec, type SizeAble, SpacerUI, type TabPositionConfig, ThemeCtx, Tree, TreeEntryUI, TreeIcon1UI, TreeNode, type TreeScrollOptions, type TreeStorageConfig, TreeUI, TreeView, TreeViewCtx, TreeWidget, Trigger, VIOLATION, WidgetBoolUI, WidgetChoices_BodyUI, WidgetChoices_HeaderUI, WidgetChoices_SelectHeaderUI, WidgetChoices_TabHeaderUI, WidgetColorUI, type WidgetConfigFields, WidgetErrorsUI, WidgetFieldsContainerUI, WidgetGroup_BlockUI, WidgetGroup_LineUI, WidgetHeaderContainerUI, WidgetHeaderControlsContainerUI, WidgetInlineRunUI, WidgetLabelCaretAlwaysUI, WidgetLabelCaretUI, type WidgetLabelContainerProps, WidgetLabelContainerUI, WidgetLabelIconUI, WidgetList_BodyUI, WidgetList_LineUI, WidgetMardownUI, WidgetMatrixUI, type WidgetMenuAction, WidgetMenuUI, WidgetNumberUI, WidgetSeedUI, WidgetSelectManyUI, WidgetSelectMany_SelectUI, WidgetSelectMany_TabUI, WidgetSelectOneUI, WidgetSelectOne_SelectUI, WidgetSelectOne_TabUI, type WidgetSerialFields, WidgetSizeX_LineUI, WidgetSpacerUI, WidgetString_HeaderUI, WidgetString_TextareaBodyUI, WidgetString_TextareaHeaderUI, WidgetTooltipUI, WidgetUndoChangesButtonUI, WidgetWithLabelUI, Widget_ToggleUI, Widget_bool, type Widget_bool_config, type Widget_bool_serial, type Widget_bool_types, type Widget_bool_value, Widget_button, type Widget_button_config, type Widget_button_context, type Widget_button_serial, type Widget_button_types, type Widget_button_value, Widget_choices, type Widget_choices_config, type Widget_choices_serial, type Widget_choices_types, type Widget_choices_value, Widget_color, type Widget_color_config, type Widget_color_serial, type Widget_color_types, type Widget_color_value, Widget_group, type Widget_group_config, type Widget_group_serial, type Widget_group_types, type Widget_group_value, Widget_list, type Widget_list_config, type Widget_list_serial, type Widget_list_types, type Widget_list_value, Widget_markdown, type Widget_markdown_config, type Widget_markdown_serial, type Widget_markdown_types, type Widget_markdown_value, Widget_matrix, type Widget_matrix_cell, type Widget_matrix_config, type Widget_matrix_serial, type Widget_matrix_types, type Widget_matrix_value, Widget_number, type Widget_number_config, type Widget_number_serial, type Widget_number_types, type Widget_number_value, Widget_optional, type Widget_optional_config, type Widget_optional_serial, type Widget_optional_types, type Widget_optional_value, Widget_seed, type Widget_seed_config, Widget_seed_fromValue, type Widget_seed_serial, type Widget_seed_types, type Widget_seed_value, Widget_selectMany, type Widget_selectMany_config, Widget_selectMany_fromValue, type Widget_selectMany_serial, type Widget_selectMany_types, type Widget_selectMany_value, Widget_selectOne, type Widget_selectOne_config, Widget_selectOne_fromValue, type Widget_selectOne_serial, type Widget_selectOne_types, type Widget_selectOne_value, Widget_shared, type Widget_shared_config, Widget_shared_fromValue, type Widget_shared_serial, type Widget_shared_types, type Widget_shared_value, Widget_size, type Widget_size_config, Widget_size_fromValue, type Widget_size_serial, type Widget_size_types, type Widget_size_value, Widget_spacer, type Widget_spacer_config, Widget_spacer_fromValue, type Widget_spacer_serial, type Widget_spacer_types, type Widget_spacer_value, Widget_string, type Widget_string_config, Widget_string_fromValue, type Widget_string_serial, type Widget_string_types, type Widget_string_value, WigetSizeXUI, WigetSize_BlockUI, WigetSize_LineUI, activityManager, addRule, allIcons, applyBoxToCtx, applyKolorToOKLCH, asSTRING_orCrash, bang, clamp, clampOpt, command, commandManager, compileKolorToCSSExpression, computePlacement, debounce, defaultDarkTheme, defaultHideDelay_whenNested, defaultHideDelay_whenRoot, defaultShowDelay_whenNested, defaultShowDelay_whenRoot, defaultTreeStorage, exhaust, extractNormalizeBox, formatOKLCH, frames, genUID, getActualWidgetToDisplay, getAllIcons, getClassNameForSize, getCurrentForm_IMPL, getId, getIfWidgetNeedAlignedLabel, getLCHFromString, getLCHFromStringAsString, getNum, getOS, getWidgetClass, global_RevealStack, hasMod, hasRule, hashKolor, isBoundCommand, isBoundMenu, isCommand, isPromise, isWidget, isWidgetGroup, isWidgetOptional, isWidgetShared, isWidgetString, makeAutoObservableInheritance, makeLabelFromFieldName, menu, menuWithoutProps, menu_widgetActions, normalizeBoxKolor, normalizeCushyShortcut, normalizeProblem, normalizeText, onKeyDownHandlers, openRouterInfos, overrideKolor, parseFloatNoRoundingErr, parseShortcutToInputSequence, registerWidgetClass, runWithGlobalForm, searchMatches, toastError, toastImage, toastInfo, toastSuccess, unaccent, useCushyKit, useCushyKitOrNull, usePressLogic, useReveal, useRevealOrNull, useSizeOf, useTheme, useTreeView };
