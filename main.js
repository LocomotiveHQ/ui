...
var getBaseColor = (isActive) => {
  if (isActive)
    return { contrast: 0.1, chroma: 0.04 };
...
var MenuWithoutProps = class {
  ...
  constructor(def) {
    this.def = def;
    // 🔴
    this.UI = () => createElement5(MenuRootUI, { menu: useMemo5(() => new MenuInstance(this, {}), []) });
    this.DropDownUI = () => createElement5(MenuRootUI, { menu: useMemo5(() => new MenuInstance(this, {}), []) });
    /** bind a menu to give props */
